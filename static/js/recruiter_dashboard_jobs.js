...
document.addEventListener("click", function (event) {
  var button = event.target.closest(".J9_emp_dash_jobs_right_side_body_emp_jobs_table_body_row_action_button");

  if (!button) {
    var dropdowns = document.querySelectorAll(".J9_emp_dash_jobs_right_side_body_emp_jobs_table_body_row_action_ul");
